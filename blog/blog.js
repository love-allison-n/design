...
// Navigation through page
    ...
    function reset() {
      tick01[0].style.right = "55px"; tick01[0].style.opacity = ".75"; tick01[0].style.color = "#f3e1c7";
      tick02[0].style.right = "55px"; tick02[0].style.opacity = ".75"; tick02[0].style.color = "#f3e1c7";
      tick1[0].style.right = "55px"; tick1[0].style.opacity = ".75"; tick1[0].style.color = "#f3e1c7";
      tick11[0].style.right = "55px"; tick11[0].style.opacity = ".75"; tick11[0].style.color = "#f3e1c7";
      ...
      tick2[0].style.right = "55px"; tick2[0].style.opacity = ".75"; tick2[0].style.color = "#f3e1c7";
    }

...
// Navigation through page
    ...
    var pdfprint = document.getElementById('pdf');

    function reset() {
      tick01[0].style.right = "55px"; tick01[0].style.opacity = ".75"; tick01[0].style.color = "#ffece2";
      tick02[0].style.right = "55px"; tick02[0].style.opacity = ".75"; tick02[0].style.color = "#ffece2";
      tick1[0].style.right = "55px"; tick1[0].style.opacity = ".75"; tick1[0].style.color = "#ffece2";
      tick11[0].style.right = "55px"; tick11[0].style.opacity = ".75"; tick11[0].style.color = "#ffece2";
      tick12[0].style.right = "55px"; tick12[0].style.opacity = ".75"; tick12[0].style.color = "#ffece2";
      tick13[0].style.right = "55px"; tick13[0].style.opacity = ".75"; tick13[0].style.color = "#ffece2";
      tick21[0].style.right = "55px"; tick21[0].style.opacity = ".75"; tick21[0].style.color = "#ffece2";
      tick22[0].style.right = "55px"; tick22[0].style.opacity = ".75"; tick22[0].style.color = "#ffece2";
      ...
      tick31[0].style.right = "55px"; tick31[0].style.opacity = ".75"; tick31[0].style.color = "#000D13";
      tick32[0].style.right = "55px"; tick32[0].style.opacity = ".75"; tick32[0].style.color = "#000D13";
      tick33[0].style.right = "55px"; tick33[0].style.opacity = ".75"; tick33[0].style.color = "#000D13";
      tick4[0].style.right = "55px"; tick4[0].style.opacity = ".75"; tick4[0].style.color = "#000D13";
      tick41[0].style.right = "55px"; tick41[0].style.opacity = ".75"; tick41[0].style.color = "#000D13";
      tick2[0].style.right = "55px"; tick2[0].style.opacity = ".75"; tick2[0].style.color = "#ffece2";
    }
    ...
    function postOne() {
      ...
      pdfprint.href = "print/solidGround.pdf";
    ...
    function postTwo() {
      ...
      pdfprint.href = "print/rangitotoIsland.pdf";
    ...
    function postThree() {
      ...
      pdfprint.href = "print/westAuckland.pdf";
    ...
    function postFour() {
      ...
      pdfprint.href = "print/minorDiscrepancies.pdf";
    ...
    function postFive() {
      ...
      pdfprint.href = "print/cityEscape.pdf";
    ...
    function postSix() {
      ...
      pdfprint.href = "print/byTheBay.pdf";
    ...
    function postEight() {
      ...
      pdfprint.href = "print/mostLivableCity.pdf";
